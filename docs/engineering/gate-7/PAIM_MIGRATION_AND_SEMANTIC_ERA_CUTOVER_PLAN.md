...
| `0011_gate8_case_continuity` | prospective Case Continuity Status/Determination and exact Case/Configuration relationship projections | Slice-B-created prospective Cases only; no legacy backfill or phase mapping |
