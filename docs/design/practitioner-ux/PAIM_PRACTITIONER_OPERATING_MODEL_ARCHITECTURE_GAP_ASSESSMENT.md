...
| Decision Authority | Separate Decision Authorization Basis and fail-closed authority behavior. | Strong fit. Must remain separate from practical role and task assignment. No redesign should turn `Decision Maker` into authority. |
