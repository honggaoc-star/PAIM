...
For the shortest supported path to a healthy local instance and first Case/Configuration context,
use the [PAIM v0.1 Quick Start](docs/operations/PAIM_QUICK_START_v0.1.md).
