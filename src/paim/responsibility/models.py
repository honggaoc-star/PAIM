...
class ObligationKind(StrEnum):
    ...
    PROPOSE_MANAGEMENT_DECISION = "PROPOSE_MANAGEMENT_DECISION"
    AUTHORIZE_MANAGEMENT_DECISION = "AUTHORIZE_MANAGEMENT_DECISION"
    CONFIRM_MANAGEMENT_DECISION = "CONFIRM_MANAGEMENT_DECISION"
    ...
    BEGIN_CONTINUING_REVIEW = "BEGIN_CONTINUING_REVIEW"
    ...
    AUTHOR_QUANTITATIVE_CLAIM = "AUTHOR_QUANTITATIVE_CLAIM"
    ESTABLISH_QUANTITATIVE_COMPARABILITY = "ESTABLISH_QUANTITATIVE_COMPARABILITY"
